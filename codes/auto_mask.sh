...
#echo $new_m
			...
			for i in {1..5}; do
				...
				echo "python Model.py -day 10 -n 3000 -i 1 -dir pr$j_q$k_w$l -f $i --no-ani"
				python Model.py -day 10 -n 3000 -i 1 -dir pr$j_q$k_w$l -f $i --no-ani &
